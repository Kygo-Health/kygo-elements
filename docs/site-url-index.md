...
**Source:** [kygo.app/sitemap.xml](https://www.kygo.app/sitemap.xml) (pages + blog-posts sitemaps)
**Last Updated:** 2026-06-13
**Totals:** 10 site pages, 14 tools, 34 blog posts

This is the canonical list of every live URL on kygo.app. Regenerate by pulling the two child sitemaps (`/pages-sitemap.xml`, `/blog-posts-sitemap.xml`). Tool detail/descriptions live in `Kygo Tools Directory.md`.

> **Deep-linking note (for components):** when a `kygo-*` tool links out to another tool or post,
> use a URL from this file so internal links never 404. The Supplements by Metric explorer
> (`kygo-supplements-by-metric.js`) deep-links each metric to its sibling factor tool below
> (latency → sleep-latency-factors, deep → deep-sleep-factors, WASO → staying-asleep-factors,
...
| LLMs.txt | https://www.kygo.app/llms-txt |
...
Sorted newest first by sitemap `lastmod`.

| Date | Post | URL |
|------|------|-----|
| 2026-05-28 | Oura Ring 5 vs Ring 4: Is the Upgrade Worth It? | https://www.kygo.app/post/oura-ring-5-vs-ring-4-is-the-upgrade-worth-it-evidence-based |
| 2026-05-20 | Fitbit Air vs WHOOP: Which Screenless Tracker Is Worth It | https://www.kygo.app/post/fitbit-air-vs-whoop-which-screenless-tracker-is-worth-it |
| 2026-05-14 | Apple Watch Stress Tracking Explained | https://www.kygo.app/post/apple-watch-stress-tracking-explained |
| 2026-05-14 | WHOOP Stress Score & Recovery Explained | https://www.kygo.app/post/whoop-stress-score-recovery-explained |
| 2026-05-14 | Oura Ring Stress Tracking Explained | https://www.kygo.app/post/oura-ring-stress-tracking-explained |
| 2026-05-14 | How Wearables Measure Stress (Comparison) | https://www.kygo.app/post/how-wearables-measure-stress-comparison |
| 2026-05-14 | Pixel Watch & Fitbit Stress Tracking Explained | https://www.kygo.app/post/pixel-watch-fitbit-stress-tracking-explained |
...
## Metric → matching factor tool & post (used by Supplements by Metric deep links)

| Metric | Factor tool | Closest existing blog post |
|--------|-------------|----------------------------|
| Sleep Latency | /tools/sleep-latency-factors | /post/how-to-fall-asleep-faster-factors-ranked-by-evidence |
| Deep Sleep | /tools/deep-sleep-factors | /post/how-to-increase-deep-sleep-factors-ranked |
| Staying Asleep | /tools/staying-asleep-factors | /post/how-to-stay-asleep-factors-ranked-by-evidence |
| HRV | /tools/hrv-factors | /post/how-to-improve-hrv-factors-ranked-by-evidence |
| Resting HR | /tools/resting-heart-rate-factors | /post/resting-heart-rate-factors |
| Recovery / Readiness | /tools/recovery-score-explorer | _(no dedicated post yet)_ |
