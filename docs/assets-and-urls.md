...
| `273a63_46b3b6ce5b4e4b0c9c1e0a681a79f9e7` | **WHOOP** logo (owner-confirmed 2026-07) | Used as the WHOOP `imageUrl`/`whoopImg` in the comparison pages (`kygo-fitbit-air-vs-whoop.js` hero + tables, `kygo-vo2max-accuracy.js` etc.). Was previously **mislabeled "Health Connect"** and briefly used that way in the homepage 3-step card — corrected to the real Health Connect asset (`273a63_0c0e48cc065d4ee3bf506f6d47440518`) |
...
| `273a63_0c0e48cc065d4ee3bf506f6d47440518` | **Health Connect** logo (owner-confirmed 2026-07) | The real Health Connect asset. Used in the homepage 3-step "Connect your wearable" card (`kygo-bundle.js` → `kygo-insights-steps`). Previously mislabeled here as "Whoop / retired" |
