...
## ✅ Decision (2026-07-30): Family A only, inline

Scope locked to the **9 Family-A pages** (sleep-tracker + the 8 semantic-palette tools), using the
inline prototype approach. Family B (11 pages) + `calories-in-anything` are **deferred** (would need
the shared-component approach or per-generation rewrites). All 9 shipped + browser-verified.

## Approach options (for reference)
...
| 8 | kygo-oura-5-vs-4 | oura-ring-5-vs-4 | A | sleep-tracker-accuracy, wearable-accuracy, calorie-burn-accuracy (swapped: page already cross-links the 3-gen tool) | ✅ |
...
| 10 | kygo-sleep-metrics | sleep-metrics | B | deep-sleep-factors, rem-sleep-factors, sleep-tracker-accuracy | ⬜ deferred |
| 11 | kygo-deep-sleep-factors | deep-sleep-factors | A | staying-asleep-factors, sleep-latency-factors, supplements-by-metric | ✅ |
| 12 | kygo-sleep-latency-factors | sleep-latency-factors | B | deep-sleep-factors, staying-asleep-factors, supplements-by-metric | ⬜ deferred |
| 13 | kygo-staying-asleep-factors | staying-asleep-factors | B | sleep-latency-factors, deep-sleep-factors, supplements-by-metric | ⬜ deferred |
| 14 | kygo-rem-sleep | rem-sleep-factors | A | deep-sleep-factors, staying-asleep-factors, sleep-metrics | ✅ |
| 15 | kygo-hrv-factors | hrv-factors | B | resting-heart-rate-factors, recovery-score-explorer, supplements-by-metric | ⬜ deferred |
| 16 | kygo-rhr-factors | resting-heart-rate-factors | B | hrv-factors, recovery-score-explorer, supplements-by-metric | ⬜ deferred |
| 17 | kygo-recovery-scores | recovery-score-explorer | B | hrv-factors, resting-heart-rate-factors, stress-factors | ⬜ deferred |
| 18 | kygo-vo2max-factors | vo2-max-factors | A | vo2-max-accuracy, recovery-score-explorer, hrv-factors | ✅ |
| 19 | kygo-wearable-stress | stress-factors | B | recovery-score-explorer, hrv-factors, resting-heart-rate-factors | ⬜ deferred |
| 20 | kygo-supplements-by-metric | supplements-by-metric | B | hrv-factors, deep-sleep-factors, recovery-score-explorer | ⬜ deferred |
| 21 | calories-custom-element | calories-in-anything | S | supplements-by-metric, wearable-accuracy, sleep-metrics | ⬜ deferred |
