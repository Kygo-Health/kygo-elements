...
class KygoOuraRingComparison extends HTMLElement {
  ...
  _relatedPosts() {
    return [
      ...
      { slug: 'oura-ring-food-tracking-complete-guide',
        title: 'Oura Meals and Food Tracking: How to Combine Them (2026 Guide)',
        blurb: 'Your ring tracks sleep, HRV and recovery but cannot tell you why they change. How to pair Oura with food tracking and see the link.',
        cat: 'Nutrition', min: 8, img: '273a63_59d966f3eb8a430cb8f444d92f4078e9~mv2.png' }
    ];
  }
  ...
  _appCta() {
    return {
      slug: 'oura-ring-comparison-tool',
      hook: `Whichever Oura you wear, find out what is actually moving your scores.`,
      headline: `Your ring tracks the data. <span>Kygo tells you what moves it.</span>`,
      sub: `Whichever Oura you wear, Kygo connects to it and cross-checks every sleep, HRV and recovery reading against what you actually eat.`
    };
  }
  ...
  _emailCta() {
    return { source: 'tool-oura-ring-comparison', variant: 'comparison' };
  }
