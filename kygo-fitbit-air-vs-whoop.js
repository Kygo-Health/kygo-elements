        ...
        <div class="section-inner">
          <div class="kygo-cta-card animate-on-scroll">
            ...
            <div class="cta-btn-row">
              <a class="btn btn-primary btn-lg cta-primary" href="https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy" data-track-position="late" data-track-label="fitbit-whoop-late-ios" target="_blank" rel="noopener">${this._icon('apple')} Download for iOS</a>
