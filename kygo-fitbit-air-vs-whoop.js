  ...
  get _specs() {
    ...
    return {
      ...
      'Form & Battery': [
        ...
        { name: 'Battery (on device)', air: y('~7 days'), whoop5: '4+ days', whoopMG: '4+ days', winner: 'air' },
        { name: 'Battery (extended)', info: 'Slide-on power pack', air: n('n/a'), whoop5: 'Up to 14 days, whoopMG: 'Up to 14 days', winner: 'whoop' },
