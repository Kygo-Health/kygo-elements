...
class KygoFitbitAirVsWhoop extends HTMLElement {
  ...
  _relatedPosts() {
    return [
      { slug: 'fitbit-air-vs-whoop-which-screenless-tracker-is-worth-it',
        title: 'Fitbit Air vs WHOOP: Which Screenless Tracker Is Actually Worth It? (2026)',
        blurb: 'A $99 screenless band aimed straight at WHOOP. On paper they look identical, and the similarities end at the surface.',
        cat: 'Wearables & Data', min: 12, img: '273a63_3377c7490d01499ea7f8a47dffb5835a~mv2.png' },
      { slug: 'does-the-fitbit-air-measure-blood-pressure',
        title: 'Does the Fitbit Air Measure Blood Pressure? (2026)',
        blurb: 'No, and no Fitbit ever has. The full sensor list, why the Google Health app shows a number anyway, and which wearables really do.',
        cat: 'Wearables & Data', min: 11, img: '273a63_488943e9d9c946459e0c2f58d680ffa9~mv2.png' },
  ...
  _appCta() {
    return {
      slug: 'fitbit-air-vs-whoop-comparison',
      hook: `Whichever band you keep, see which of its readings you can act on.`,
      headline: `Get the most accurate metric <span>from each wearable.</span>`,
      sub: `Kygo connects to both Fitbit and WHOOP, then cross-checks every reading against what you eat, train and sleep.`
    };
  }
