...
class KygoFitbitAirVsWhoop extends HTMLElement {
  ...
  _relatedTools() {
    return [
      ...
      { title: 'Calorie Burn Accuracy', blurb: 'Enter your reported calorie burn and see the likely real range, with per-activity accuracy.', url: 'https://www.kygo.app/tools/calorie-burn-accuracy', meta: 'Wearables · 22 sources', motif: { motif: 'diverging', caption: 'Reported vs actual', bars: [{ label: 'Oura', val: 9 }, { label: 'Apple', val: 22 }, { label: 'Fitbit', val: -16 }, { label: 'Garmin', val: -31 }] } },
        ...
        <div class="section-inner">
          <div class="kygo-cta-card animate-on-scroll">
            ...
            <div class="cta-btn-row">
              <a class="btn btn-primary btn-lg cta-primary" href="https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy" data-track-position="late" data-track-label="fitbit-whoop-late-ios" target="_blank" rel="noopener">${this._icon('apple')} Try Free for 7 Days</a>
              <a class="btn btn-primary btn-lg cta-android" href="https://track.tenjin.com/v0/click/eMjS3ZkseCvs2lO9AVESkO" data-action="android-download" data-track-position="late" data-track-label="fitbit-whoop-late-android" target="_blank" rel="noopener">${this._icon('android')} Download for Android</a>
            </div>
