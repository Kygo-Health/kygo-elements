...
class KygoSleepTrackerAccuracy extends HTMLElement {
  ...
  _appCta() {
    return {
      slug: 'sleep-tracker-accuracy',
      hook: `See what your tracker's sleep numbers mean once your meals sit beside them.`,
      headline: `See what your <span>sleep data</span> is really telling you.`,
      sub: `Your tracker estimates your stages. Kygo connects your sleep, nutrition and recovery so you can act on the trend, not chase a single night's number.`
    };
  }
  ...
  _emailCta() {
    return { source: 'tool-sleep-tracker-accuracy', variant: 'comparison' };
  }
