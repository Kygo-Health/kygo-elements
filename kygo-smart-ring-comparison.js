...
class KygoSmartRingComparison extends HTMLElement {
  ...
  get _models() {
    return [
      ...
      { key: 'cudisc', brand: 'cudis', name: 'CUDIS 002 Classic', short: '002 Classic', hw: 349, sub: 0, addon: 0, battery: 10,
        ...
        why: 'No subscription, a 10-day battery that reviewers beat, and the strongest sleep agreement of the four brands in one hands-on test. A temperature sensor confirmed by CUDIS support, but no published spec sheet and no published validation.',
      ...
      { key: 'cudiss', brand: 'cudis', name: 'CUDIS 002 Sporty', short: '002 Sporty', hw: 399, sub: 0, addon: 0, battery: 10,
        ...
        why: 'The Classic plus 12 interchangeable silicone bands and a Sports Mode, at $50 more. Same sensor set as the Classic, including the temperature sensor CUDIS confirmed by email, and the same lack of any published accuracy data.',
        v: { evidence: 'None published', apnea: 'Not claimed', women: 'Cycle tracking, temperature-based', usnow: 'Shipping now' },
        s: { nosub: 100, evidence: 5, apnea: 0, women: 40, usnow: 100 } },
    ];
  }
  ...
  get _specs() {
    ...
    return {
      ...
      Hardware: [
        ...
        { name: 'Skin temperature sensor', info: 'Drives cycle and illness features', ring5: y('Yes'), ring4: y('Yes'), gen3: y('Yes'), gen2: y('Yes'), gen2air: y('Yes'), uhpro: y('Yes'), uhair: y('Yes, non-contact'), cudisc: y('Yes, per CUDIS support'), cudiss: y('Yes, per CUDIS support') },
  ...
  get _features() {
    return {
      ...
      Heart: [
        ...
        { name: 'Skin temperature trends', o: [true, 'Yes'], r: [true, 'Yes'], u: [true, '24/7, non-contact sensor'], c: [true, 'Sensor confirmed by CUDIS support; feeds cycle features'] },
      ...
      "Women's health": [
        { name: 'Cycle phase tracking', o: [true, 'Cycle Insights (temperature-based)'], r: [true, 'Full-cycle predictions (temperature-based)'], u: [true, 'Free Cycle & Ovulation PowerPlug'], c: [true, 'Temperature-based, per CUDIS support; no feature page'] },
  ...
  get _bestFor() {
    ...
    return [
      ...
      { icon: 'wallet', label: 'For changeable styling with no recurring fee', pick: 'CUDIS 002 Sporty', reason: 'The only ring here with interchangeable bands, 12 of them, plus a Sports Mode and a battery two testers beat the claim on. Go in knowing what is missing: no published spec sheet or accuracy figure of any kind. The temperature sensor and temperature-based cycle tracking are confirmed only by CUDIS support, not by any CUDIS page.', price: '$399', yrly: '· Classic $349' },
    ];
  }
  ...
  get _faqs() {
    return [
      ...
      { q: 'Does the CUDIS ring measure temperature?', a: 'Yes, though CUDIS does not say so anywhere public. No product page, the how-it-works page, the Amazon listing or the privacy policy\'s list of collected data mentions temperature, and hands-on reviews describe only an optical sensor and motion sensors. CUDIS support confirmed by email in September 2026 that both 002 models have a skin temperature sensor and that cycle features are temperature-derived. There is no published spec or accuracy figure for it, and no confirmation that the app shows a temperature trend.' },
    ...
    return `
      ...
      <div class="cmp-blocks">
        ...
        <div class="cmp-block">
          ...
          <p>$349 or $399, no subscription, and a battery two testers beat the claim on. No engineering spec and no accuracy figure. It does have a skin temperature sensor, confirmed by CUDIS support rather than by any published page. Absent data is not proof it is inaccurate, just that nobody has published either way.</p>
        </div>
  ...
  get _caveats() {
    return [
      ...
      { icon: 'moon', title: 'CUDIS has a temperature sensor, but you would never know it from CUDIS', body: 'No CUDIS-published surface mentions one: not the product pages, not the how-it-works page, not the Amazon listing, and not the privacy policy, which enumerates what CUDIS collects (steps, sleep, heart rate, HRV, resting heart rate, SpO2, distance, cycling cadence, active calories) with temperature absent. Independent hands-on reviews describe an optical sensor and motion sensors only. Asked directly, CUDIS support confirmed in September 2026 that both 002 models carry a skin temperature sensor and that its cycle features are temperature-derived. Treat it as confirmed hardware with no published spec: no sampling rate, no accuracy figure, and no statement of what else it drives.', src: 'CUDIS support, email, September 2026 · cudis.xyz privacy policy · Wareable hands-on' },
