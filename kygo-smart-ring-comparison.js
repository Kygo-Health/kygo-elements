...
class KygoSmartRingComparison extends HTMLElement {
  ...
  get _models() {
    return [
      ...
      { key: 'cudisc', brand: 'cudis', name: 'CUDIS 002 Classic', short: '002 Classic', hw: 349, sub: 0, addon: 0, battery: 10,
        ...
        why: 'No subscription, a 10-day battery that reviewers beat, and the strongest sleep agreement of the four brands in one hands-on test. A temperature sensor, but no published spec sheet and no published validation.',
        v: { evidence: 'None published', apnea: 'Not claimed', women: 'Cycle tracking, temperature-based', usnow: 'Shipping now' },
        s: { nosub: 100, evidence: 5, apnea: 0, women: 40, usnow: 100 } },
      { key: 'cudiss', brand: 'cudis', name: 'CUDIS 002 Sporty', short: '002 Sporty', hw: 399, sub: 0, addon: 0, battery: 10,
        ...
        why: 'The Classic plus 12 interchangeable silicone bands and a Sports Mode, at $50 more. Same sensor set as the Classic, including the temperature sensor, and the same lack of any published accuracy data.',
        v: { evidence: 'None published', apnea: 'Not claimed', women: 'Cycle tracking, temperature-based', usnow: 'Shipping now' },
        s: { nosub: 100, evidence: 5, apnea: 0, women: 40, usnow: 100 } },
    ];
  }
  ...
  get _specs() {
    ...
    return {
      ...
      Hardware: [
        ...
        { name: 'Skin temperature sensor', info: 'Drives cycle and illness features. CUDIS 002: confirmed by CUDIS support, email, September 2026, not stated on any CUDIS page.', ring5: y('Yes'), ring4: y('Yes'), gen3: y('Yes'), gen2: y('Yes'), gen2air: y('Yes'), uhpro: y('Yes'), uhair: y('Yes, non-contact'), cudisc: y('Yes'), cudiss: y('Yes') },
        { name: 'Sensors', ring5: '2 photodetectors, dual triple LEDs, 12 pathways, temp, accel', ring4: 'Red/green/IR LEDs, 3 photodiodes, temp, accel', gen3: 'Optical HR, temp, 3-axis accel, vibration motor', gen2: 'Optical HR, temp, accel', gen2air: 'Optical HR, temp, accel', uhpro: 'Redesigned PPG, temp, 6-axis IMU', uhair: 'Infrared PPG, red + green + IR LEDs, temp, 6-axis', cudisc: 'Optical PPG (HR, HRV, SpO2), temp, motion', cudiss: 'Optical PPG (HR, HRV, SpO2), temp, motion' },
      ...
      Validation: [
        ...
        { name: 'FDA clearance held by the brand', ring5: n('None'), ring4: n('None'), gen3: n('None'), gen2: n('None'), gen2air: n('None'), uhpro: n('None. AFib runs on FibriCheck K173872'), uhair: n('None. AFib runs on FibriCheck K173872'), cudisc: n('None'), cudiss: n('None') },
  ...
  get _features() {
    return {
      ...
      Heart: [
        ...
        { name: 'Skin temperature trends', o: [true, 'Yes'], r: [true, 'Yes'], u: [true, '24/7, non-contact sensor'], c: [true, 'Yes, feeds cycle features'] },
      ...
      "Women's health": [
        { name: 'Cycle phase tracking', o: [true, 'Cycle Insights (temperature-based)'], r: [true, 'Full-cycle predictions (temperature-based)'], u: [true, 'Free Cycle & Ovulation PowerPlug'], c: [true, 'Temperature-based'] },
        { name: 'Period prediction', o: [true, 'Yes'], r: [true, 'Yes, with advance reminders'], u: [true, 'Yes'], c: [false, 'Not listed'] },
        { name: 'Ovulation prediction / confirmation', info: 'Both need a temperature sensor', o: [true, 'Select countries'], r: [true, 'Ovulation-day temperature-dip detection'], u: [true, 'Cycle & Ovulation Pro, paid, powered by OvuSense'], c: [false, 'Not listed'] },
  ...
  get _faqs() {
    return [
      ...
      { q: 'Does the CUDIS ring measure temperature?', a: 'Yes. Both 002 models carry a skin temperature sensor and the cycle features are derived from it. CUDIS confirmed this by email in September 2026; it is not stated on any CUDIS page, and no spec or accuracy figure has been published for it.' },
      ...
      { q: 'Which ring is best for cycle and ovulation tracking?', a: 'Oura and Ultrahuman, with RingConn close behind. Oura offers cycle insights, period prediction, pregnancy insights and pairing with Natural Cycles, the FDA-cleared birth-control app, which no other brand here lists. Ultrahuman has a free Cycle and Ovulation PowerPlug plus a paid Pro tier powered by OvuSense, though OvuSense\'s headline 99% figure belongs to its vaginal sensor, not skin temperature. RingConn does full-cycle prediction with temperature-dip ovulation detection at no subscription. CUDIS has a temperature sensor and says its cycle tracking uses it, but publishes no ovulation, period-prediction or pregnancy feature, so it is the thinnest option here.' },
  ...
  _relatedPosts() {
    return [
      { slug: 'best-smart-ring-oura-vs-ringconn-vs-ultrahuman-vs-cudis',
        title: 'Best Smart Ring: Oura vs RingConn vs Ultrahuman vs CUDIS',
        blurb: 'Nine models across four brands, $199 to $1,799, and only one with peer-reviewed accuracy data. Specs, real three-year cost and availability.',
        cat: 'Wearables & Data', min: 14, img: '273a63_0f91ff715c524a77a516eab0d1c45111~mv2.png' },
  ...
  _appCta() {
    return {
      ...
      hook: `Whichever ring wins for you, see which habits move what it records.`,
        ...
        <div class="hero-light-inner">
          <div class="hero-grid">
            ...
            <div class="hero-vis" aria-hidden="true">
              ...
              <p class="hero-vis-foot">What each brand publishes on its own pages, not a quality score.</p>
            </div>
          </div>
      ...
      <section class="section bg-white">
        <div class="section-inner">
          <div class="section-head animate-on-scroll">
            ...
            <p class="lede">Four common buyer profiles with our pick for each. Use the finder above to weight it differently.</p>
          </div>
      ...
      <section class="section bg-light">
        <div class="section-inner">
          <div class="section-head animate-on-scroll">
            ...
            <p class="lede">No ring here is a medical device and none holds an FDA clearance of its own. The difference between these brands is not the sensor, it is who has verified the output. One caution: an absent study is not a failed study. Three of these brands have not been independently tested, so their accuracy is unknown rather than bad, which is a real risk but a different one.</p>
          </div>
      ...
      <section class="section bg-light">
        <div class="section-inner">
          <div class="section-head animate-on-scroll">
            ...
            <p class="lede">Every price, spec and policy here was read on the company's own pages in September 2026, with the regulatory facts pulled from the primary record: the Federal Register, the CBP rulings database and the openFDA API. Independent reviews are used only where a manufacturer publishes nothing, and are labelled as such.</p>
          </div>
  ...
  _renderTLDR() {
    return `
      <p class="tldr-lead">Every ring here reads the same finger with the same basic optical sensor. What separates them is the business model, the evidence, and in two cases whether you can legally buy one.</p>
      <div class="cmp-blocks">
        <div class="cmp-block">
          <h3><span class="cmp-logo">${this._brandMark('oura')}</span> Oura</h3>
          <p class="cmp-verdict">The longest feature list, and the only independent validation.</p>
          <p>$399 for the Ring 5 or $349 for the Ring 4, plus $69.99/yr. You are renting the software, and it is the best-evidenced software here.</p>
        </div>
        <div class="cmp-block">
          <h3><span class="cmp-logo">${this._brandMark('ringconn')}</span> RingConn</h3>
          <p class="cmp-verdict">The most published capability per dollar.</p>
          <p>$349 flat for the Gen 3, or $199 for the Gen 2 Air. No subscription on any model, 14-day battery, case in the box, and sleep apnea monitoring nobody else lists.</p>
        </div>
        <div class="cmp-block">
          <h3><span class="cmp-logo">${this._brandMark('ultrahuman')}</span> Ultrahuman</h3>
          <p class="cmp-verdict">The widest ecosystem, the thinnest evidence base.</p>
          <p>$479 for the Ring PRO: 15 rated days, plus a first-party CGM and blood-panel stack. It is still a US pre-order, the Ring AIR is barred from the US, and no independent study has tested either.</p>
        </div>
        <div class="cmp-block">
          <h3><span class="cmp-logo">${this._brandMark('cudis')}</span> CUDIS</h3>
          <p class="cmp-verdict">The least published information of the four.</p>
          <p>$349 or $399, no subscription, and a battery two testers beat the claim on. No engineering spec and no accuracy figure. Has a skin temperature sensor. No engineering spec and no accuracy figure. Absent data is not proof it is inaccurate, just that nobody has published either way.</p>
        </div>
        <div class="cmp-block cmp-block-wide">
          <h3>So which should you buy?</h3>
          <p class="cmp-verdict">No ring here wins on every axis, so pick the trade-off you prefer.</p>
          <p>Gen 3 for the most published capability with nothing recurring, at the cost of a smaller software list. Oura for accuracy someone outside the company has checked and the deepest app, at roughly $250 more over three years. Ring PRO for the longest battery and a CGM and blood-panel stack, if you can wait out the US pre-order. CUDIS or the $199 Gen 2 Air for the lowest price, accepting that CUDIS publishes no specs or accuracy figures.</p>
        </div>
      </div>
    `;
  }
  ...
  _renderCalc() {
    ...
    const a = this._model(this._calcPick[0]);
    const b = this._model(this._calcPick[1]);
    ...
    return `
      <div class="calc-controls">
        <div class="calc-block">
          <div class="label"><span>Compare two rings</span></div>
          <div class="seg seg-wrap" role="group" aria-label="Choose two rings to compare">${seg}</div>
        </div>
        <div class="calc-block">
  ...
  get _validation() {
    return [
      { brand: 'oura', title: "Oura's posture", tag: 'Independent peer-reviewed studies', body: 'The only brand here that points to peer-reviewed validation studies it did not run, plus a medical advisory board. That is the strongest evidence base here, not proof of accuracy: being measured is not the same as scoring well, and several studies find Oura poor on specific metrics. Its own marketing is still marketing. "Research-grade" and a pulse signal "up to 100x stronger" than a wrist device are unverified company claims, and roughly 5M paid members and a 2026 IPO filing are scale, not evidence.' },
      ...
      { brand: 'cudis', title: "CUDIS's posture", tag: 'No published accuracy data', body: 'No study, no third-party testing, and not a single per-metric number on any CUDIS surface. The claims it does make are outcome claims rather than accuracy ones: "15 more hours of deep sleep per month" and "30% less chance of getting injury" come from internal data with no sample definition, no control group and no stated method. That is the youngest evidence base of the four, and it cuts both ways: nobody outside the company has tested these rings, so the accuracy is unknown rather than poor.' },
    ];
  }
  ...
  get _caveats() {
    return [
      ...
      { icon: 'battery', title: 'What is not in the box changes the price', body: 'The charging case, not the ring, is what turns a six-day battery into a multi-week one, and only two brands include one. Oura ships the Ring 5 with a pad only; the case that holds about five charges is a $99 add-on. Ultrahuman includes the PRO Charging Case with the Ring PRO, currently free, but the older Ring AIR ships with a pad and its Voyager charger is $45. RingConn puts a wireless case in the Gen 3 and Gen 2 boxes and a wired dock in the Gen 2 Air, with an optional $39.90 case. CUDIS includes a USB-C pod, though the $50 spare has been showing sold out. Compare ring plus case, not ring, or the cheapest column on this page is not the cheapest ring.', src: 'Each brand\'s own accessory and battery pages, verified September 2, 2026' },
  ...
  _renderCaveats() {
    return this._caveats.map(c => `
      <div class="caveat animate-on-scroll">
        <div class="caveat-head"><span class="caveat-ico">${this._icon(c.icon)}</span><h3>${c.title}</h3></div>
        <p>${c.body}</p>
  ...
  get _srcGroups() {
    return [
      ...
      },
      {
        ...
        links: [
          { t: 'CUDIS support correspondence, September 2026 (temperature sensor and temperature-based cycle tracking confirmed)', c: 'Email, not published on any CUDIS page' },
          ...
          { t: 'Privacy policy (health data types, temperature not enumerated, "we do not sell Personal Data")', u: 'https://www.cudis.xyz/policies/privacy-policy' },
  ...
  get _sources() {
    ...
    for (const g of this._srcGroups) {
      for (const l of g.links) out.push({ tag: g.group, title: l.t, cite: l.c || '', url: l.u });
    }
    return out;
  }
  ...
  _bindEvents() {
    ...
    calc.addEventListener('click', (e) => {
      ...
      if (!btn) return;
      const k = btn.dataset.segVal;
      if (this._calcPick.includes(k)) return;   // already in the pair
      this._calcPick = [this._calcPick[1], k];  // the older pick drops out
      this._updateCalc();
    });
  ...
  _styles() {
    return `
      ...
      * { box-sizing: border-box; }
      ...
      .hero-vis { position: relative; overflow: hidden; display: flex; flex-direction: column; gap: 6px; background: linear-gradient(158deg, #ffffff 0%, #EEF2F7 100%); border: 1px solid var(--border-subtle); border-radius: 20px; padding: 18px 20px; justify-content: center; box-shadow: 0 16px 40px rgba(15,23,42,0.08); }
      ...
      @media (max-width: 880px) { .hero-vis { width: 100%; max-width: none; margin: 6px 0 0; padding: 16px 18px; } }
      ...
      .hero-vis-foot { margin: 12px 0 0; font-size: 11.5px; line-height: 1.45; color: var(--fg-3); }
      /* Hero bars in HTML, so the labels stay at their real size on a phone */
      .hv-bars { display: flex; flex-direction: column; gap: 11px; margin-top: 14px; }
      .hv-bar { display: grid; grid-template-columns: 76px minmax(0,1fr) 26px; align-items: center; gap: 10px; }
      .hv-lbl { font-family: var(--font-display); font-weight: 600; font-size: 12.5px; color: var(--fg-2); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
      ...
      .cmp-logo img { width: 17px; height: 17px; object-fit: contain; display: block; }
      ...
      .fr-empty { display: flex; align-items: center; gap: 12px; background: #fff; border: 1.5px solid var(--kygo-green-light); border-radius: 14px; padding: 14px 16px; }
      .fr-empty-ico { flex: none; width: 30px; height: 30px; border-radius: 9px; background: var(--kygo-green-light); color: var(--kygo-green-dark); display: flex; align-items: center; justify-content: center; }
      .fr-empty-ico .ico { width: 16px; height: 16px; }
      .fr-empty p { margin: 0; font-size: 13.5px; line-height: 1.5; color: var(--fg-2); }
      ...
      .caveat { display: flex; flex-direction: column; background: #fff; border: 1.5px solid var(--border-subtle); border-radius: 18px; padding: 22px; box-shadow: var(--shadow-md); }
      .caveat-head { display: flex; align-items: center; gap: 11px; margin-bottom: 10px; }
      .caveat-ico { flex: none; width: 30px; height: 30px; border-radius: 9px; background: var(--kygo-green-light); color: var(--kygo-green-dark); display: flex; align-items: center; justify-content: center; }
      .caveat-ico .ico { width: 16px; height: 16px; }
      .caveat-head h3 { font-family: var(--font-display); font-weight: 600; font-size: 17px; line-height: 1.25; margin: 0; color: var(--fg-1); }
      .caveat p { margin: 0 0 12px; font-size: 14px; line-height: 1.6; color: var(--fg-2); }
