...
class KygoVo2maxFactors extends HTMLElement {
  ...
  _relatedTools() {
    return [
      ...
      { title: 'Recovery Score Explorer', blurb: 'Compare recovery scores across 12 wearables and see the 35 factors that move yours.', url: 'https://www.kygo.app/tools/recovery-score-explorer', meta: 'Recovery · 12 wearables', motif: { motif: 'ring', caption: 'Readiness score', ringValue: 72, ringNote: 'Validated' } },
      { title: 'HRV Factor Explorer', blurb: '38 research-backed factors that affect Heart Rate Variability, ranked by evidence.', url: 'https://www.kygo.app/tools/hrv-factors', meta: 'Recovery · 38 factors', motif: { motif: 'pulse', caption: 'HRV, beat-to-beat' } }
    ];
  }
        ...
        <div class="section-inner">
          <div class="kygo-cta-card animate-on-scroll">
            ...
            <div class="cta-btn-row">
              <a class="btn btn-primary btn-lg cta-primary" href="https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy" target="_blank" rel="noopener" data-track-position="early" data-track-label="vo2max-factors-early-ios">${this._icon('apple')} Try Free for 7 Days</a>
              <a class="btn btn-primary btn-lg cta-android" href="https://track.tenjin.com/v0/click/eMjS3ZkseCvs2lO9AVESkO" target="_blank" rel="noopener" data-action="android-download" data-track-position="early" data-track-label="vo2max-factors-early-android">${this._icon('android')} Download for Android</a>
            </div>
