...
class KygoToolsPage extends HTMLElement {
  ...
  _defaultTools() {
    return [
      ...
      { slug: 'deep-sleep-factors', title: 'Deep Sleep Factor Explorer', description: 'What affects your deep sleep? 28 factors ranked by research — with evidence strength, doses, and mechanisms from 40+ studies.', icon: 'moon', badge: 'Sleep', url: '/tools/deep-sleep-factors', features: ['28 evidence-based factors', '5 categories', '29 peer-reviewed sources'] },
  ...
  _motifFor(tool) {
    ...
    const map = {
      ...
      'heart-rate-accuracy': { motif: 'compare', caption: 'HR accuracy vs strap', rows: [{ label: 'Fitbit', pct: 94 }, { label: 'Garmin', pct: 88 }, { label: 'Pixel', pct: 84 }, { label: 'Oura', pct: 60 }] },
      ...
      'smart-ring-comparison': { motif: 'compare', caption: 'Published features', rows: [{ label: 'Oura', pct: 80 }, { label: 'Ultra', pct: 62 }, { label: 'RingConn', pct: 56 }, { label: 'CUDIS', pct: 30 }] },
      'oura-vs-ringconn': { motif: 'versus', caption: 'Features vs value', versusA: 'Oura', versusB: 'RingConn', versus: [{ a: 92, b: 58 }, { a: 55, b: 90 }, { a: 60, b: 88 }] },
              ...
              <div class="promo-inner">
                ...
                <div class="works-with">
                  ...
                  <div class="works-dots">
                    ...
                    <span class="wd" title="WHOOP"><span class="wd-tile"><img src="https://static.wixstatic.com/media/273a63_21019d0fbe9e4afcbabdb3ca9dcad89d~mv2.png" alt="WHOOP" loading="lazy"/></span><span class="wd-label">WHOOP</span></span>
