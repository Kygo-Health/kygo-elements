...
class KygoToolsPage extends HTMLElement {
  ...
  _defaultTools() {
    return [
      ...
      { slug: 'recovery-scores', title: 'Recovery & Readiness Scores', description: 'Compare how 12 brands build a morning recovery score — WHOOP, Oura, Garmin, Fitbit, Samsung, Polar, Ultrahuman, Coros, Amazfit, Suunto, Apple & RingConn — the 35 factors that move it, and which scores are actually validated.', icon: 'heart', badge: 'New', url: '/tools/recovery-scores', category: 'recovery', features: ['12 brands compared', '35 factors ranked', 'Only 2/12 scores validated'] },
