...
class KygoToolsPage extends HTMLElement {
  ...
  _defaultTools() {
    return [
      ...
      { slug: 'sleep-tracker-accuracy', title: 'Most Accurate Sleep Tracker', description: 'Which wearable is most accurate for sleep vs a lab PSG? Compare Oura, Apple Watch, Fitbit, WHOOP, Garmin & Withings on 4-stage staging (healthy vs clinical), deep & REM detection, sleep/wake agreement, and total-sleep-time bias.', icon: 'moon', badge: 'New', url: '/tools/sleep-tracker-accuracy', category: 'wearables', features: ['7 devices ranked vs PSG', 'Healthy vs clinical accuracy', '14 verified sources'] },
