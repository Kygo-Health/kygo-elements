...
class KygoRemSleep extends HTMLElement {
  ...
  _relatedTools() {
    return [
      { title: 'Deep Sleep Factor Explorer', blurb: '28 factors that affect deep sleep, ranked by research with doses and mechanisms.', url: 'https://www.kygo.app/tools/deep-sleep-factors', meta: 'Sleep · 40+ studies', motif: { motif: 'hypno', stage: 'deep', caption: 'Sleep stages overnight' } },
      ...
      { title: 'Sleep Metrics Comparison', blurb: 'Compare 38 sleep metrics tracked by Oura, Fitbit, Apple Watch and Garmin across 10 categories.', url: 'https://www.kygo.app/tools/sleep-metrics', meta: 'Sleep · 29 sources', motif: { motif: 'dots', caption: 'Metrics tracked', dots: [{ label: 'Oura', n: 9 }, { label: 'Garmin', n: 7 }, { label: 'Apple', n: 6 }, { label: 'Fitbit', n: 5 }] } }
    ];
  }
        ...
        <div class="section-inner">
          <div class="kygo-cta-card animate-on-scroll">
            ...
            <div class="cta-btn-row">
              <a class="btn btn-primary btn-lg cta-primary" href="${iosUrl}" target="_blank" rel="noopener" data-track-position="early" data-track-label="rem-sleep-early-ios">${this._icon('apple')} Try Free for 7 Days</a>
              <a class="btn btn-primary btn-lg cta-android" href="https://track.tenjin.com/v0/click/eMjS3ZkseCvs2lO9AVESkO" target="_blank" rel="noopener" data-action="android-download" data-track-position="early" data-track-label="rem-sleep-early-android">${this._icon('android')} Download for Android</a>
            </div>
