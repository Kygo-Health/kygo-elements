      ...
      <section class="cta-section animate-on-scroll">
        <div class="container">
          ...
          <div class="cta-buttons">
            ...
            <a href="https://kygo.app/android" target="_blank" rel="noopener" class="cta-button-secondary" data-action="android-download" data-track-position="footer-cta"><svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16"><path d="M17.523 2.246a.75.75 0 0 0-1.046 0l-1.817 1.818a8.212 8.212 0 0 0-5.32 0L7.523 2.246a.75.75 0 1 0-1.046 1.078L8.088 4.92A8.25 8.25 0 0 0 3.75 12v.75a8.25 8.25 0 0 0 16.5 0V12a8.25 8.25 0 0 0-4.338-7.08l1.611-1.596a.75.75 0 0 0 0-1.078zM9 10.5a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25zm6 0a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25z"/></svg> Download for Android</a>
          </div>
        </div>
      </section>
