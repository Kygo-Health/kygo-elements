...
class CaloriesInAnything extends HTMLElement {
  ...
  attachEventListeners() {
    const _ab = this.querySelector('.cta-android');
    const _am = this.querySelector('.android-modal');
    const _mc = this.querySelector('.modal-close');
    const _af = this.querySelector('.android-form');
