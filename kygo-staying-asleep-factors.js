    ...
    this.shadowRoot.innerHTML = `
      ...
      <header class="header">
        <div class="header-inner">
          ...
          <a href="${iosUrl}" class="header-link cta-primary" data-track-label="subnav-get-app" data-track-position="subnav" target="_blank" rel="noopener">
      ...
      <section class="kearly-section">
        <div class="container">
          <div class="kearly animate-on-scroll">
            <p class="kearly-copy">Stop guessing which of these applies to you. Kygo correlates your meals, caffeine, and alcohol with YOUR sleep stages.</p>
            <div class="kearly-btns">
              <a href="${iosUrl}" class="blog-cta-btn cta-primary" data-track-position="early" data-track-label="staying-asleep-early-ios" target="_blank" rel="noopener">
              ...
              <a href="https://www.kygo.app/android" class="cta-android" data-action="android-download" data-track-position="early" data-track-label="staying-asleep-early-android" target="_blank" rel="noopener">
          ...
          <div class="blog-cta animate-on-scroll">
            ...
            <div class="blog-cta-content">
              ...
              <div class="blog-cta-buttons">
                ...
                <a href="https://www.kygo.app/android" target="_blank" rel="noopener" class="cta-android" data-action="android-download" data-track-position="footer-cta" data-track-label="staying-asleep-footer-android">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M17.523 2.246a.75.75 0 0 0-1.046 0l-1.817 1.818a8.212 8.212 0 0 0-5.32 0L7.523 2.246a.75.75 0 1 0-1.046 1.078L8.088 4.92A8.25 8.25 0 0 0 3.75 12v.75a8.25 8.25 0 0 0 16.5 0V12a8.25 8.25 0 0 0-4.338-7.08l1.611-1.596a.75.75 0 0 0 0-1.078zM9 10.5a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25zm6 0a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25z"/></svg>
