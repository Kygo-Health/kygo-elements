        ...
        <div class="section-inner">
          <div class="kygo-cta-card animate-on-scroll">
            ...
            <div class="cta-btn-row">
              <a class="btn btn-primary btn-lg cta-primary" href="https://apps.apple.com/us/app/kygo-nutrition-wearables/id6749870589" target="_blank" rel="noopener" data-track-position="early" data-track-label="vo2max-accuracy-early-ios">${this._icon('apple')} Download for iOS</a>
              <a class="btn btn-primary btn-lg cta-android" href="https://www.kygo.app/android" target="_blank" rel="noopener" data-action="android-download" data-track-position="early" data-track-label="vo2max-accuracy-early-android">${this._icon('android')} Download for Android</a>
            </div>
            <div class="cta-works">
