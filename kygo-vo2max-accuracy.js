...
class KygoVo2maxAccuracy extends HTMLElement {
  ...
  _appCta() {
    return {
      slug: 'vo2-max-accuracy',
      hook: `See what your VO2 max estimate is telling you about your real training weeks.`,
  ...
  _emailCta() {
    return { source: 'tool-vo2max-accuracy', variant: 'comparison' };
  }
