          ...
          <div class="phase-content">
            ...
            <div class="phase-visual animate-on-scroll delay-2">
              <div class="connect-flow">
                ...
                <div class="connect-step">
                  <div class="connect-step-icon">
                    <img src="https://static.wixstatic.com/media/273a63_3f4fd0ee0a0d42dd9eecbeba00b8493e~mv2.png" alt="Google Health">
                  </div>
                  <div class="connect-step-content">
                    <strong>Google Health</strong>
                    <span>Sleep, activity, recovery</span>
                  </div>
                  <div class="connect-step-status pending">+ Add</div>
                </div>
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .kearly-btns > a { display: inline-flex; align-items: center; justify-content: center; gap: 8px; width: 100%; max-width: 320px; min-height: 48px; padding: 12px 20px; border-radius: 12px; font-weight: 600; font-size: 15px; text-decoration: none; transition: all .2s; }
        .kearly-btns > a svg { width: 18px; height: 18px; flex-shrink: 0; }
        .kearly-ios { background: var(--green); color: #fff; border: none; }
        .kearly-ios:hover { background: var(--green-dark); }
        .kearly-android { background: #fff; color: var(--green-dark); border: 2px solid var(--green); }
        .kearly-android:hover { background: var(--green); color: #fff; }
...
class KygoHiwFinalCta extends HTMLElement {
  ...
  render() {
    const ctaLink = this._getSetting('cta-link', 'https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy') || this._getSetting('app-store-url', 'https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy');
          ...
          <div class="final-cta-inner animate-on-scroll">
            <div class="final-cta-content">
              ...
              <div class="cta-buttons">
                <a href="${ctaLink}" class="cta-primary" target="_blank" rel="noopener" data-track-position="footer-cta" data-track-label="how-it-works-footer-ios">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                  </svg>
                  Try Free for 7 Days
                </a>
                <a href="https://track.tenjin.com/v0/click/eMjS3ZkseCvs2lO9AVESkO" target="_blank" rel="noopener" class="cta-android" data-action="android-download" data-track-position="footer-cta" data-track-label="how-it-works-footer-android">
              ...
              <div class="cta-works">
                ...
                <div class="cta-badges">
                  ...
                  <img src="https://static.wixstatic.com/media/273a63_46b3b6ce5b4e4b0c9c1e0a681a79f9e7~mv2.png" alt="Health Connect" title="Health Connect" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
