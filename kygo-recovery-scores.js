...
class KygoRecoveryScores extends HTMLElement {
  ...
  _relatedTools() {
    return [
      ...
      {
        title: 'VO2 Max Factor Explorer',
        blurb: '39 research-backed factors that raise or lower VO2 max, ranked by evidence strength.',
        url: 'https://www.kygo.app/tools/vo2-max-factors',
        meta: 'Recovery · 40 sources',
        motif: { motif: 'gauge', caption: 'VO2 max estimate', gaugePct: 78, gaugeValue: '48', gaugeUnit: 'VO2 MAX' }
      },
      {
  ...
  _relatedPosts() {
    return [
      { slug: 'what-lowers-recovery-score',
        title: 'Recovery Score Low? The Food & Drink Causes Most People Miss',
        blurb: 'Nine times out of ten the drop is something you ate or drank the night before. How to spot your own triggers in your own data.',
        cat: 'Nutrition', min: 8, img: '273a63_1aabeb9f974c47e984894fadbe79fa16~mv2.png' },
      { slug: 'recovery-scores-compared-whoop-oura-garmin',
        title: 'Recovery Score Comparison: WHOOP vs Oura vs Garmin 2026',
        blurb: 'Every brand swears its recovery score is the smart one. They measure more of the same thing than the marketing admits.',
        cat: 'Wearables & Data', min: 7, img: '273a63_df4fa2af9cd146dd8aabc609c815210a~mv2.png' },
      { slug: 'can-you-trust-your-recovery-score',
        title: 'Can You Trust Your Recovery Score? What the Science Says',
        blurb: 'You check it every morning, but should you believe it? What the research actually validates, and what is a proprietary guess.',
        cat: 'HRV & Recovery', min: 7, img: '273a63_9588721f1d69413c8910bbcbe7cd12b4~mv2.png' }
    ];
  }
  ...
  _appCta() {
    return {
      slug: 'recovery-score-explorer',
      hook: `See the reason behind your recovery score, in your own food and training.`,
      headline: `Your recovery score, <span>with the reason attached.</span>`,
      sub: `Most recovery scores are unvalidated black boxes. Kygo connects yours to what you ate, drank and did the day before.`
    };
  }
  ...
  _styles() {
    return `
      ...
      *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .app-cta-btn { display: inline-flex; align-items: center; gap: 8px; background: var(--green); color: #fff; padding: 12px 24px; border-radius: var(--radius-sm); font-weight: 600; font-size: 15px; text-decoration: none; transition: background 0.2s; white-space:nowrap; }
