    ...
    this.shadowRoot.innerHTML = `
      ...
      <header class="header">
        <div class="header-inner">
          ...
          <a href="https://track.tenjin.com/v0/click/cD7zgIPLuiZMMWmWkXLsvy" class="header-cta cta-primary" data-track-label="subnav-get-app" data-track-position="subnav" target="_blank" rel="noopener">
  ...
  _styles() {
    return `
      ...
      *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .header-cta { background: var(--green); color: #fff; text-decoration: none; font-size: 13px; display: inline-flex; align-items: center; gap: 6px; font-weight: 600; padding: 8px 14px; border-radius: 8px; transition: background 0.2s; }
